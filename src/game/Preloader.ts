...
export default class MainScene extends Phaser.Scene {
  ...
  preload() {
    ...
    this.load.atlas("character-sprite", this.characterSprite, CharacterSpriteFrames); // character-sprite-frame is same for all characters so it doesn't need to be passed in. Made with: https://asyed94.github.io/sprite-sheet-to-json/
  }
